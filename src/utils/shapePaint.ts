...
export const shapePaintHtml = (
  ...
  text?: { body: string; ink: string; fontFamily: string; align?: string; inset?: [number, number, number, number]; lineHeight?: number; letterSpacing?: number; paragraphSpace?: number },
) => {
